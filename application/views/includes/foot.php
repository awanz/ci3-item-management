...
<script src="<?= base_url('assets/adminbsb/') ?>plugins/bootstrap-notify/bootstrap-notify.js"></script>
...
<script src="<?= base_url('assets/adminbsb/') ?>js/pages/ui/dialogs.js"></script>

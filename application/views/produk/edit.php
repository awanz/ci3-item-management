            ...
            <div class="body">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" value="<?= $data->namaProduk ?>" name="namaProduk" class="form-control" placeholder="Masukan Nama Produk">
                        </div>
                        <?php 
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" value="<?= $data->harga ?>" name="harga" class="form-control" placeholder="Masukan Harga">
                        </div>
                        <?php 
                            if (form_error('harga')) {
                    ...
                    <div class="form-group">
                        <div class="form-line">
                            <input type="text" value="<?= $data->stok ?>" name="stok" class="form-control" placeholder="Masukan Stok">
                        </div>
                        <?php 
                            if (form_error('stok')) {
                    ...
                    <div class="form-group">
                        <img src="<?= base_url("assets/images/produk/".$data->foto) ?>" alt="" height="200px">
                    </div>
                    
                    <label for="deskripsi">Deskripsi</label>
                    <div class="form-group">
                        <div class="form-line">
                            <textarea rows="4" name="deskripsi" class="form-control no-resize" placeholder="Deskripsi"><?= $data->deskripsi ?></textarea>
                        </div>
                    </div>
                        ...
                        <select class="form-control show-tick" name="idKategori">
                            ...
                            <?php 
                                foreach ($kategori as $value) {
                                    if ($data->idKategori == $value->idKategori) {
                                        echo '<option selected value="'.$value->idKategori.'">'.$value->namaKategori.'</option>';
                                    }else{
                        ...
                        <select class="form-control show-tick" name="idMerek">
                            ...
                            <?php 
                                foreach ($merek as $value) {
                                    if ($data->idMerek == $value->idMerek) {
                                        echo '<option selected value="'.$value->idMerek.'">'.$value->namaMerek.'</option>';
                                    }else{
                    ...
                    <div class="clearfix">
                        <input name="status" type="radio" id="baru" value="Baru" <?php if($data->status == "Baru"){echo "checked";} ?> />
                        <label for="baru">Baru</label>
                        <input name="status" type="radio" id="bekas" value="Bekas" <?php if($data->status == "Bekas"){echo "checked";} ?> />
